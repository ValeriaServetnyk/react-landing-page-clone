        ...
        <section css={heroTextContainer}>
          <div>
            ...
            <p css={heroParagraphStyles}>
              ...
              better. Download Triage 2 on the App Store today.
            </p>
          ...
          <section css={redTextContainer}>
            ...
            <div>
              ...
              >
                ...
                />
                <path
                  d="M12.4883 24.0039C12.4883 24.4609 12.6875 24.9414 13.0039 25.2578L20.6445 32.875C20.9961 33.2266 21.418 33.4023 21.8281 33.4023C22.8242 33.4023 23.5039 32.7109 23.5039 31.7969C23.5039 31.293 23.2812 30.8828 22.9648 30.5781L20.3398 27.9531L17.7383 25.5625L20.3047 25.7031H33.5469C34.6016 25.7031 35.3047 25.0117 35.3047 24.0039C35.3047 22.9844 34.6016 22.3047 33.5469 22.3047H20.3047L17.75 22.4453L20.3398 20.0547L22.9648 17.418C23.2812 17.1133 23.5039 16.7148 23.5039 16.1992C23.5039 15.2852 22.8242 14.5937 21.8281 14.5937C21.418 14.5937 20.9961 14.7695 20.6328 15.1328L13.0039 22.75C12.6875 23.0664 12.4883 23.5469 12.4883 24.0039Z"
                  fill="white"
                />
              </svg>
              <h1 css={redHeaderStyles}>Drag left to archive.</h1>
              <p css={redParagraphStyles}>
        ...
        <section css={greyPageStyles}>
          <div css={colorosContainer}>
            <div css={blueSectionStyles}>
              ...
              <div>
                <h1 css={blueSectionText}>Works with Gmail, iCloud & IMAP</h1>
              </div>
            </div>
            ...
            <div css={pinkSectionStyles}>
              ...
              <div>
                <h1 css={pinkSectionText}>Your data is yours to stay</h1>
              </div>
            </div>
            <div css={blackSectionStyles}>
              ...
              <div>
                <h1 css={blackSectionText}>Supports dark mode</h1>
              </div>
            </div>
            ...
            <div css={purpleSectionStyles}>
              ...
              <div>
                <h1 css={purpleSectionText}>
                  Free to use. Or pay for more features.
                </h1>
              </div>
            </div>
            <div css={whiteSectionStyles}>
              ...
              <div>
                <h1 css={whiteSectionText}>
                  Built & maintained by indie developers
                </h1>
              </div>
            </div>
          </div>
          ...
          <div css={feedbackContainer}>
            <a href="/" css={feedbackIconsStyles}>
              <div css={commentSectionStyles}>
                <div>
                  <span>
                    Since I`ve been using Triage, I`m more caught up on my email
            ...
            <a href="/" css={feedbackIconsStyles}>
              <div css={commentSectionStyles}>
                <div>
                  <span>
                    If you're constantly battling to keep your email account at
                    inbox zero, Triage for iOS could be worth a look.
                  </span>
                </div>
                <div>
            ...
            <a href="/" css={feedbackIconsStyles}>
              <div css={commentSectionStyles}>
                <div>
                  <span>
                    Triage makes it feel seamless, and even fun, to achieve — if
                    not Inbox Zero — at least Inbox Zen.
                  </span>
                </div>
                <div>
                  <img
            ...
            <a href="/" css={feedbackIconsStyles}>
              <div css={commentSectionStyles}>
                <div>
                  <span>
                    Triage provides the first aid necessary to get your inbox
            ...
            <a href="/" css={feedbackIconsStyles}>
              <div css={commentSectionStyles}>
                <div>
                  <span>
                    Triage is a boon to those who have struggled to keep their
                    inboxes clean and organized.
                  </span>
                </div>
                <div>
                  <img
            ...
            <a href="/" css={feedbackIconsStyles}>
              <div css={commentSectionStyles}>
                <div>
                  <span>Triage is my new favorite email app for iPhone.</span>
                </div>
                <div>
                  <img
                    css={sixthCommentPic}
