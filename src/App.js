...
<div>
<svg css={redArrowIcon} class="h-8 w-8 lg:h-12 lg:w-12 mb-4" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 24C0 10.7452 10.7452 0 24 0V0C37.2548 0 48 10.7452 48 24V24C48 37.2548 37.2548 48 24 48V48C10.7452 48 0 37.2548 0 24V24Z" fill="white" fill-opacity="0.3"></path>
          <path d="M12.4883 24.0039C12.4883 24.4609 12.6875 24.9414 13.0039 25.2578L20.6445 32.875C20.9961 33.2266 21.418 33.4023 21.8281 33.4023C22.8242 33.4023 23.5039 32.7109 23.5039 31.7969C23.5039 31.293 23.2812 30.8828 22.9648 30.5781L20.3398 27.9531L17.7383 25.5625L20.3047 25.7031H33.5469C34.6016 25.7031 35.3047 25.0117 35.3047 24.0039C35.3047 22.9844 34.6016 22.3047 33.5469 22.3047H20.3047L17.75 22.4453L20.3398 20.0547L22.9648 17.418C23.2812 17.1133 23.5039 16.7148 23.5039 16.1992C23.5039 15.2852 22.8242 14.5937 21.8281 14.5937C21.418 14.5937 20.9961 14.7695 20.6328 15.1328L13.0039 22.75C12.6875 23.0664 12.4883 23.5469 12.4883 24.0039Z" fill="white"></path>
        </svg>
...
dark mode
  ...
  <div>
    <svg css={fifthContainerIcon} class="h-8 w-8 lg:h-12 lg:w-12 mb-4" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 24C0 10.7452 10.7452 0 24 0V0C37.2548 0 48 10.7452 48 24V24C48 37.2548 37.2548 48 24 48V48C10.7452 48 0 37.2548 0 24V24Z" fill="white" fill-opacity="0.2"></path>
...
<nav>
 ...
 <footer css={socialMenuStyles}>
  <div>
  <svg css={footerIcons} xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
      </svg>
    </div>
  <div>
  <svg css={footerIcons} xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 248 204" stroke="currentColor">
